...
const loader = async ({ params }) => {
    return defer({
        ...
        // cards: Promise.all(
        //     [
        //         startGetCards(params.type),
        //         getLocalCardKeys(params.type)
        //     ]
        // ),
        // cloudCards: startGetCards(params.type),
        // localCardKeys: getLocalCardKeys(params.type)
        // items: {
        //     cards: startGetCards(params.type),
        //     images: startGetImages(params.type)
        // }
    })
}
